...
var tabelas_pocoes = {
  ...
  endure_elements: { nome: 'Endure elements', tipo: 'pocao'  , preco: '50 PO' },
  hide_from_animals: { nome: 'Hide from animals', tipo: 'pocao'  , preco: '50 PO' },
  hide_from_undead: { nome: 'Hide from undead', tipo: 'pocao' , preco: '50 PO' },
  jump: { nome: 'Jump', tipo: 'pocao' , preco: '50 PO' },
  mage_armor: { nome: 'Mage armor', tipo: 'pocao' , preco: '50 PO' },
  magic_fang: { nome: 'Magic fang', tipo: 'pocao' , preco: '50 PO' },
  magic_stone: { nome: 'Magic stone', tipo: 'oleo' , preco: '50 PO' },
  magic_weapon: { nome: 'Magic weapon', tipo: 'oleo'  , preco: '50 PO' },
  pass_without_trace: { nome: 'Pass without trace', tipo: 'pocao' , preco: '50 PO' },
  protection_from_alignment: { nome: 'Protection from (alignment)', tipo: 'pocao'  , preco: '50 PO' },
  remove_fear: { nome: 'Remove fear', tipo: 'pocao'  , preco: '50 PO' },
  sanctuary: { nome: 'Sanctuary', tipo: 'pocao'  , preco: '50 PO' },
  shield_of_faith_2: { nome: 'Shield of faith +2', tipo: 'pocao' , preco: '50 PO' },
  shillelagh: { nome: 'Shillelagh', tipo: 'oleo'  , preco: '50 PO' },
  bless_weapon: { nome: 'Bless weapon', tipo: 'oleo'  , preco: '100 PO' },
  enlarge_person: { nome: 'Enlarge person', tipo: 'pocao' , preco: '250 PO' },
  reduce_person: { nome: 'Reduce person', tipo: 'pocao'  , preco: '250 PO' },
  aid: { nome: 'Aid', tipo: 'pocao'  , preco: '300 PO' },
  barkskin_2: { nome: 'Barkskin +2', tipo: 'pocao'  , preco: '300 PO' },
  bears_endurance: { nome: 'Bear’s endurance', tipo: 'pocao' , preco: '300 PO' },
  blur: { nome: 'Blur', tipo: 'pocao' , preco: '300 PO' },
  bulls_strength: { nome: 'Bull’s strength', tipo: 'pocao'  , preco: '300 PO' },
  cats_grace: { nome: 'Cat’s grace', tipo: 'pocao'  , preco: '300 PO' },
  cure_moderate_wounds: { nome: 'Cure moderate wounds', tipo: 'pocao' , preco: '300 PO' },
  darkness: { nome: 'Darkness', tipo: 'oleo'  , preco: '300 PO' },
  darkvision: { nome: 'Darkvision', tipo: 'pocao' , preco: '300 PO' },
  delay_poison: { nome: 'Delay poison', tipo: 'pocao' , preco: '300 PO' },
  eagles_splendor: { nome: 'Eagle’s splendor', tipo: 'pocao' , preco: '300 PO' },
  foxs_cunning: { nome: 'Fox’s cunning', tipo: 'pocao'  , preco: '300 PO' },
  invisibility: { nome: 'Invisibility', tipo: 'ambos'  , preco: '300 PO' },
  lesser_restoration: { nome: 'Lesser restoration', tipo: 'pocao' , preco: '300 PO' },
  levitate: { nome: 'Levitate', tipo: 'ambos'  , preco: '300 PO' },
  misdirection: { nome: 'Misdirection', tipo: 'pocao' , preco: '300 PO' },
  owls_wisdom: { nome: 'Owl’s wisdom', tipo: 'pocao' , preco: '300 PO' },
  protection_from_arrows_10_magic: { nome: 'Protection from arrows 10/magic', tipo: 'pocao'  , preco: '300 PO' },
  remove_paralysis: { nome: 'Remove paralysis', tipo: 'pocao' , preco: '300 PO' },
  resist_energy_10: { nome: 'Resist energy (type) 10', tipo: 'pocao'  , preco: '300 PO' },
  shield_of_faith_3: { nome: 'Shield of faith +3', tipo: 'pocao' , preco: '300 PO' },
  spider_climb: { nome: 'Spider climb', tipo: 'pocao' , preco: '300 PO' },
  undetectable_alignment: { nome: 'Undetectable alignment', tipo: 'pocao' , preco: '300 PO' },
  barkskin_3: { nome: 'Barkskin +3', tipo: 'pocao'  , preco: '600 PO' },
  shield_of_faith_4: { nome: 'Shield of faith +4', tipo: 'pocao' , preco: '600 PO' },
  resist_energy_20: { nome: 'Resist energy (type) 20', tipo: 'pocao'  , preco: '700 PO' },
  cure_serious_wounds: { nome: 'Cure serious wounds', tipo: 'pocao'  , preco: '750 PO' },
  daylight: { nome: 'Daylight', tipo: 'oleo'  , preco: '750 PO' },
  displacement: { nome: 'Displacement', tipo: 'pocao' , preco: '750 PO' },
  flame_arrow: { nome: 'Flame arrow', tipo: 'oleo' , preco: '750 PO' },
  fly: { nome: 'Fly', tipo: 'pocao'  , preco: '750 PO' },
  gaseous_form: { nome: 'Gaseous form', tipo: 'pocao' , preco: '750 PO' },
  greater_magic_fang_1: { nome: 'Greater magic fang +1', tipo: 'pocao'  , preco: '750 PO' },
  greater_magic_weapon_1: { nome: 'Greater magic weapon +1', tipo: 'oleo' , preco: '750 PO' },
  haste: { nome: 'Haste', tipo: 'pocao'  , preco: '750 PO' },
  heroism: { nome: 'Heroism', tipo: 'pocao'  , preco: '750 PO' },
  keen_edge: { nome: 'Keen edge', tipo: 'oleo' , preco: '750 PO' },
  magic_circle_against_alignment: { nome: 'Magic circle against (alignment)', tipo: 'pocao' , preco: '750 PO' },
  magic_vestment_1: { nome: 'Magic vestment +1', tipo: 'oleo' , preco: '750 PO' },
  neutralize_poison: { nome: 'Neutralize poison', tipo: 'pocao'  , preco: '750 PO' },
  nondetection: { nome: 'Nondetection', tipo: 'pocao' , preco: '750 PO' },
  protection_from_energy: { nome: 'Protection from energy (type)', tipo: 'pocao'  , preco: '750 PO' },
  rage: { nome: 'Rage', tipo: 'pocao' , preco: '750 PO' },
  remove_blindness_deafness: { nome: 'Remove blindness/deafness', tipo: 'pocao'  , preco: '750 PO' },
  remove_curse: { nome: 'Remove curse', tipo: 'pocao' , preco: '750 PO' },
  remove_disease: { nome: 'Remove disease', tipo: 'pocao' , preco: '750 PO' },
  tongues: { nome: 'Tongues', tipo: 'pocao'  , preco: '750 PO' },
  water_breathing: { nome: 'Water breathing', tipo: 'pocao'  , preco: '750 PO' },
  water_walk: { nome: 'Water walk', tipo: 'pocao' , preco: '750 PO' },
  barkskin_4: { nome: 'Barkskin +4', tipo: 'pocao'  , preco: '900 PO' },
  shield_of_faith_5: { nome: 'Shield of faith +5', tipo: 'pocao' , preco: '900 PO' },
  good_hope: { nome: 'Good hope', tipo: 'pocao'  , preco: '1050 PO' },
  resist_energy_30: { nome: 'Resist energy (type) 30', tipo: 'pocao'  , preco: '1100 PO' },
  barkskin_5: { nome: 'Barkskin +5', tipo: 'pocao'  , preco: '1200 PO' },
  greater_magic_fang_2: { nome: 'Greater magic fang +2', tipo: 'pocao'  , preco: '1200 PO' },
  greater_magic_weapon_2: { nome: 'Greater magic weapon +2', tipo: 'oleo' , preco: '1200 PO' },
  magic_vestment_2: { nome: 'Magic vestment +2', tipo: 'oleo' , preco: '1200 PO' },
  protection_from_arrows_15_magic: { nome: 'Protection from arrows 15/magic', tipo: 'pocao'  , preco: '1500 PO' },
  greater_magic_fang_3: { nome: 'Greater magic fang +3', tipo: 'pocao'  , preco: '1800 PO' },
  greater_magic_weapon_3: { nome: 'Greater magic weapon +3', tipo: 'oleo' , preco: '1800 PO' },
  magic_vestment_3: { nome: 'Magic vestment +3', tipo: 'oleo' , preco: '1800 PO' },
  greater_magic_fang_4: { nome: 'Greater magic fang +4', tipo: 'pocao'  , preco: '2400 PO' },
  greater_magic_weapon_4: { nome: 'Greater magic weapon +4', tipo: 'oleo' , preco: '2400 PO' },
  magic_vestment_4: { nome: 'Magic vestment +4', tipo: 'oleo' , preco: '2400 PO' },
  greater_magic_fang_5: { nome: 'Greater magic fang +5', tipo: 'pocao'  , preco: '3000 PO' },
