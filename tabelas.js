...
var tabelas_raca = {
  ...
  anao: {
      ...
      bonus_pericias: { avaliacao: 2, procurar: 2 },
  ...
  anao_das_profundezas: {
      nome: 'Anão das Profundezas',
      origem: { livro: 'Livro dos Monstros', pagina: '' },
      movimento: { terrestre: 4 },
      atributos: {constituicao: 2, carisma: -2},
      tamanho: 'medio',
      familiaridade_arma: { machado_de_guerra_anao: true, urgrosh_anao: true },
      outras_salvacoes: { veneno: { base: ['fortitude'], bonus: 3 },
                          magias: { base: ['fortitude', 'reflexo', 'vontade' ], bonus: 3, } },
      especiais: {	
		  1: ['visao_escuro'],
      },
  },
  elfo: {
      ...
      atributos: { destreza: +2, constituicao: -2 },
      tamanho: 'medio',
      proficiencia_armas: [ 'espada_longa', 'sabre', 'arco_longo', 'arco_longo_composto', 'arco_curto', 'arco_curto_composto'],
      especiais: {
		  1: ['visao_penumbra'],
      },
  ...
  gnoll: {
      ...
      movimento: { terrestre: 6 },
      atributos: { forca: 4, constituicao: 2, inteligencia: -2, carisma: -2 },
      tamanho: 'medio',
      ajuste_nivel: 1,
      armadura_natural: 1,
      bba: 1,
      salvacoes: { fortitude: 3 },
  ...
  goblin: {
      ...
      movimento: { terrestre: 6 },
      atributos: { forca: -2, destreza: 2, carisma: -2 },
      tamanho: 'pequeno',
  ...
  genasi_ar: {
      ...
      movimento: { terrestre: 6 },
      atributos: { destreza: 2, inteligencia: 2, sabedoria: -2, carisma: -2 },
	  tamanho: 'medio',
      ajuste_nivel: 1,
      // +1 contra agua no primeiro. TODO: +1 a cada 5 niveis.
  ...
  genasi_fogo: {
      ...
      origem: { livro: 'Forgotten Realms', pagina: '20' },
      movimento: { terrestre: 6 },
      atributos: { inteligencia: 2, carisma: -2 },
	  tamanho: 'medio',
      ajuste_nivel: 1,
  ...
  genasi_terra: {
      ...
      origem: { livro: 'Forgotten Realms', pagina: '19' },
      movimento: { terrestre: 6 },
      atributos: { forca: 2, constituicao: 2, sabedoria: -2, carisma: -2 },
	  tamanho: 'medio',
      ajuste_nivel: 1,
      // visao no escuro 60 pes (12 quadrados).
  ...
  gnomo: {
	  ...
	  bonus_pericias: { ouvir: 2, oficios_alquimia: 2, observar: 2 },
  ...
  meioorc: {
      ...
      origem: { livro: 'Livro do Jogador', pagina: '' },
      movimento: { terrestre: 6 },
      atributos: { forca: 2, inteligencia: -2, carisma: -2 },
	  tamanho: 'medio',
  },
  orc: {
      nome: 'Orc',
      origem: { livro: 'Livro dos Monstros', pagina: '' },
      movimento: { terrestre: 6 },
      atributos: { forca: 4, inteligencia: -2, sabedoria: -2, carisma: -2 },
	  tamanho: 'medio',
      // visao no escuro 60 pes (12 quadrados).
  },
};
