...
var tabelas_geracao = {
  ...
  aristocrata: {
    atributos: [ 'carisma', 'inteligencia', 'sabedoria', 'constituicao', 'destreza', 'forca' ],
    talentos: [],
    por_nivel: {
      // Tesouro de NPC tabela 4-23, usando um nivel a menos (Nivel de Desafio).
      ...
      5: {
        moedas: {  ouro: 130 },
        armadura: { nome: 'camisao_cota_de_malha', bonus: 1 },
        escudo: { nome: 'broquel', obra_prima: true },
        armas: [ { nome: 'sabre', bonus: 1 }, { nome: 'besta_leve', bonus: 1 } ],
        aneis: [],
        pocoes: [ 'agilidade_gato', 'curar_ferimentos_leves' ],
      },
      6: {
        moedas: {  ouro: 5600 },
        armadura: { },
